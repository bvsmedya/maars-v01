      ...
      <section id="hero" className="py-24 px-4 bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#about" className="px-6 py-3 bg-white text-blue-900 font-semibold rounded-lg hover:bg-blue-50 transition-colors">{t('hero.cta.about')}</a>
            <a href="#modules" className="px-6 py-3 border border-white/30 text-white font-semibold rounded-lg hover:bg-white/10 transition-colors">{t('hero.cta.modules')}</a>
            <a href="#programs" className="px-6 py-3 border border-white/30 text-white font-semibold rounded-lg hover:bg-white/10 transition-colors">{t('hero.cta.programs')}</a>
            <a href="#contact" className="px-6 py-3 border border-white/30 text-white font-semibold rounded-lg hover:bg-white/10 transition-colors">{t('hero.cta.contact')}</a>
          </div>
        </div>
      </section>
